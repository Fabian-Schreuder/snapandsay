...
describe('ImagePreview', () => {
    ...
    it('displays the captured image', () => {
        render(<ImagePreview imageSrc={mockImageSrc} onRetake={mockOnRetake} onConfirm={mockOnConfirm} />)
    ...
    it('calls onConfirm when confirm button is clicked', () => {
        render(<ImagePreview imageSrc={mockImageSrc} onRetake={mockOnRetake} onConfirm={mockOnConfirm} />)
        const confirmBtn = screen.getByRole('button', { name: /confirm|next|check/i }) 

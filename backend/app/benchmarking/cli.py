...
def main():
    ...
    parser.add_argument("--complexity", type=str, default="simple", choices=["simple", "complex"], help="Dish complexity")
    parser.add_argument("--seed", type=int, default=42, help="Random seed for selection")
    parser.add_argument("--api-url", type=str, default=os.getenv("API_URL", "http://localhost:8000"), help="Backend API URL")
    ...
    if not args.email or not args.password:
        parser.error("Email and password are required. Provide via --email/--password or TEST_EMAIL/TEST_PASSWORD env vars.")

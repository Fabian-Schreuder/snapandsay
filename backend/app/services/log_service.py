...
async def get_logs_for_date(db: AsyncSession, user_id: UUID, target_date: date) -> list[DietaryLog]:
    """
...
async def get_log_by_id(db: AsyncSession, user_id: UUID, log_id: UUID) -> DietaryLog | None:
    """
...
async def update_log(db: AsyncSession, user_id: UUID, log_id: UUID, update_data: dict) -> DietaryLog | None:
    """

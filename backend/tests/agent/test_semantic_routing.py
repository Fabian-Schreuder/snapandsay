...
async def test_semantic_routing_umbrella_term(mock_llm_service, mock_registry):
    ...
    # Run
    initial_state = AgentState(image_url="http://example.com/sandwich.jpg", messages=[], start_time=123.0)
...
async def test_semantic_routing_specific_term(mock_llm_service, mock_registry):
    ...
    # Run
    initial_state = AgentState(image_url="http://example.com/turkey.jpg", messages=[], start_time=123.0)
